...
public:
	...
	void readInstructionsLoop(string instructions) {
		string tempString;
		string nixbpe;
		string opCode;
		int tempFormat;
	...
	//checked*
	string stringHexToStringBinary(string hex) {
		string newTemp;
	...
	//checked*
	string stringBinaryToStringHex(string binary) {
	...
	//checked*
	string intDecimalToStringHex(int decimal) {
		int hexVal;
		string tempHex;
		string returnHex;
	...
	//checked
	int stringHexToIntDecimal(string tempString) {
	...
	//checked
	string charHextoStringBinary(char Byte) {
	...
	//checked
	char zeroToFifteenIntToHexChar(int num) {
		char tempChar;
		if (num < 10) {
			tempChar = (num + 48);
		}
	...
	//checked
	int stringBinaryToIntDecimal(string binary) {
		int result = 0;
		int temp;
